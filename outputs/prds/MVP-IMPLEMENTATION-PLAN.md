...
|---------|-------------|
| Ory Kratos/Hydra (full identity management) | Generic OIDC client covers SSO needs; full Ory stack deferred |
...
- [x] Assistant: prompt-to-crew generation via LiteLLM
