...
# Simple in-memory cache: {"data": ..., "ts": monotonic_time}
_cache: dict[str, Any] = {}
_CACHE_TTL_S = 60.0
...
async def agent_card(
    ...
    result = await session.execute(select(Resource).where(Resource.kind == ResourceKind.CREW))
